...
class ToolRegistry: 
    ...
    async def invoke(self, name: str, params: dict[str, Any], cwd: Path, hook_system: HookSystem, 
...
def create_default_registry(config: Config) -> ToolRegistry: 
    regsitry = ToolRegistry(config) 
    for tool_class in get_all_builtin_tools(): 
        regsitry.register(tool_class(config))
    for subagent_def in get_default_subagent_definitions(): 
        regsitry.register(SubagentTool(config, subagent_def))
